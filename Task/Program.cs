...
Первоначальный масссив можно ввести с клавиатуры, либо задать на старте выполнения алгоритма.
При решении не рекомендуется пользоваться коллекциями, лучше обойтись исключетительно массивами.
["hello", "2", "world", ";-)"] -> ["2",";-)"}
*/
Console.Clear();
